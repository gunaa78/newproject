...
const Services = [
  {
    ...
    description:
      ...
      ICON: <FaLaptopCode className="text-lg md:text-2xl text-black" />,
  ...
  },
  {
    ...
    description:
      "Modernize your infrastructure with secure cloud migration, deployment, and management.",
       ICON: <FaCloud className="text-lg md:text-2xl text-black" />,
      TITLE: "Cloud & DevOps",
      DESCRIPTION:
  ...
  },
  {
    ...
    description:
      ...
      ICON: <FaPaintBrush className="text-lg md:text-2xl text-black" />,
      TITLE: "UI/UX Design",
      DESCRIPTION:
  ...
  },
  {
    ...
    description:
      ...
      ICON: <HiOutlineChartBar className="text-lg md:text-2xl text-black" />,
      TITLE: "IT Consulting",
      DESCRIPTION:
